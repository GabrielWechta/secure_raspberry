...
def start_3_way_handshake(destination_ip: str, destination_port: int,
    ...
    :param verbose: Whether verbose sr1 function.
    """
    ...
    try:
        ...
        sr1(syn_packet_composed, timeout=1, verbose=verbose)  # Sending packet with expected receive
    except ValueError:
